...
class AktivniPrevoziAdapter extends ArrayAdapter<AktivniPrevozi> {
    public AktivniPrevoziAdapter(@NonNull Context context, ArrayList<AktivniPrevozi> prevozi) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        AktivniPrevozi prevoz = getItem(position);
